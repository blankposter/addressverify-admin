...
hoistedDependencies:
  ...
  /@jest/core/30.1.3(ts-node@10.9.2):
    '@jest/core': private
  ...
  /@tanstack/vue-virtual/3.13.12(vue@3.5.21):
  ...
  /@types/yargs/17.0.33:
    '@types/yargs': private
  /@typescript-eslint/eslint-plugin/8.42.0(@typescript-eslint/parser@8.42.0)(eslint@9.34.0)(typescript@5.9.2):
  ...
  /jest-circus/30.1.3:
    jest-circus: private
  /jest-cli/30.1.3(@types/node@22.18.1)(ts-node@10.9.2):
    jest-cli: private
  /jest-config/30.1.3(@types/node@22.18.1)(ts-node@10.9.2):
    jest-config: private
  /jest-diff/30.1.2:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Fri, 05 Sep 2025 09:38:17 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - /@unrs/resolver-binding-win32-ia32-msvc/1.11.1
  - /@unrs/resolver-binding-win32-x64-msvc/1.11.1
storeDir: /Users/amirdev/Library/pnpm/store/v3
